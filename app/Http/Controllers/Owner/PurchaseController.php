...
class PurchaseController extends Controller
{
    ...
    public function allPurchases()
    {
        ...
        $purchases = Purchase::with(['supplier'])->filter(request(['search'])) // 0 = not approved
            ->sortable()
            ->paginate($row)
            ->appends(request()->query());

        return view('Owner.purchases.purchases', [
            'purchases' => $purchases
        ]);
    }
    ...
    public function approvedPurchases()
    {
        ...
        return view('Owner.purchases.approved-purchases', [
            'purchases' => $purchases
        ]);
    }
    ...
    public function purchaseDetails(string $purchase_id)
    {
        ...
        return view('Owner.purchases.details-purchase', [
            'purchase' => $purchase,
    ...
    public function invoiceBill(string $purchase_id)
    {
        ...
        return view('Owner.purchases.pdf.invoice_bill', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ]);
    }
    ...
    public function PO(string $purchase_id)
    {
        ...
        return view('Owner.purchases.POLetter', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ]);
    }
    ...
    public function invoiceBillPdf(string $purchase_id)
    {
        ...
        $html = view('Owner.purchases.pdf.invoice_bill_pdf', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ])->render();
    ...
    {
        return view('Owner.purchases.create-purchase', [
    ...
    public function returnPurchase(string $purchase_id)
    {
        ...
        return view('Owner.purchases.return-purchase', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ]);
    }
    ...
    public function dailyPurchaseReport()
    {
        ...
        return view('Owner.purchases.purchases-daily', [
            'purchases' => $purchases
        ]);
    }
    ...
    public function dueDateReport()
    {
        ...
        return view('Owner.purchases.purchases-due', [
            'purchases' => $purchases
        ]);
    }
    ...
    {
        return view('Owner.purchases.report-purchase');
    }
