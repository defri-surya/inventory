...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $view = Cache::remember($cacheKey, 60, function () use ($row) {
            ...
            return view('Owner.products.index', ['products' => $products])->render();
        });
    ...
    public function show($name)
    {
        ...
        $productUrl = route('products.show', ['name' => $name]);
    ...
    public function changeStatus(Request $request, $id)
    {
        ...
        return redirect()->route('products.index')->with('success', 'Status product telah diperbarui!');
    }
}
