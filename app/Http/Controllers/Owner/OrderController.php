...
class OrderController extends Controller
{
    ...
    public function pendingOrders()
    {
        ...
        return view('Owner.orders.pending-orders', [
            'orders' => $orders
        ]);
    }
    ...
    public function completeOrders()
    {
        ...
        return view('Owner.orders.complete-orders', [
            'orders' => $orders
        ]);
    }
    ...
    public function dueOrders()
    {
        ...
        return view('Owner.orders.due-orders', [
            'orders' => $orders
        ]);
    }
    ...
    public function dueOrderDetails(String $order_id)
    {
        ...
        return view('Owner.orders.details-due-order', [
            'order' => $order,
    ...
    public function orderDetails(String $order_id)
    {
        ...
        return view('Owner.orders.details-order', [
    ...
    public function downloadInvoice(Int $order_id)
    {
        ...
        return view('Owner.orders.print-invoice', [
            'order' => $order,
    ...
    public function storeDO(Request $request)
    {
        ...
        return redirect()->route('order.orderPendingDetails', $deliveryOrder->id_order)->with('success', 'Delivery order created successfully');
    }
    ...
    public function createDelivery(String $order_id)
    {
        ...
        return view('Owner.orders.delivery-create', [
            'order' => $order,
        ]);
    }
    ...
    public function deliveryOrder(Int $order_id)
    {
        ...
        return view('Owner.orders.delivery-order', [
            'order' => $order,
            'orderDetails' => $orderDetails,
        ]);
    }
