...
class PurchaseGudangController extends Controller
{
    ...
    public function allPurchases()
    {
        ...
        return view('StaffGudang.purchases.purchases', [
            'purchases' => $purchases
        ]);
    }
    ...
    public function approvedPurchases()
    {
        ...
        return view('StaffGudang.purchases.approved-purchases', [
            'purchases' => $purchases
        ]);
    }
    ...
    public function purchaseDetails(string $purchase_id)
    {
        ...
        return view('StaffGudang.purchases.details-purchase', [
            'purchase' => $purchase,
    ...
    public function invoiceBill(string $purchase_id)
    {
        ...
        return view('StaffGudang.purchases.pdf.invoice_bill', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ]);
    }
    ...
    public function PO(string $purchase_id)
    {
        ...
        return view('StaffGudang.purchases.POLetter', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ]);
    }
    ...
    public function invoiceBillPdf(string $purchase_id)
    {
        ...
        $html = view('StaffGudang.purchases.pdf.invoice_bill_pdf', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ])->render();
    ...
    {
        return view('StaffGudang.purchases.create-purchase', [
    ...
    public function storePurchase(Request $request)
    {
        ...
        return Redirect::route('purchasesGudang.allPurchases')->with('success', 'Purchase has been created!');
    }
    ...
    public function updatePurchase(Request $request)
    {
        ...
        return Redirect::route('purchasesGudang.allPurchases')->with('success', 'Purchase has been approved!');
    }
    ...
    public function returnPurchase(string $purchase_id)
    {
        ...
        return view('StaffGudang.purchases.return-purchase', [
            'purchase' => $purchase,
            'purchaseDetails' => $purchaseDetails,
        ]);
    }
    ...
    public function deletePurchase(string $purchase_id)
    {
        ...
        return Redirect::route('purchasesGudang.allPurchases')->with('success', 'Purchase has been deleted!');
    }
    ...
    public function dailyPurchaseReport()
    {
        ...
        return view('StaffGudang.purchases.purchases-daily', [
            'purchases' => $purchases
        ]);
    }
    ...
    public function dueDateReport()
    {
        ...
        return view('StaffGudang.purchases.purchases-due', [
            'purchases' => $purchases
        ]);
    }
    ...
    {
        return view('StaffGudang.purchases.report-purchase');
    }
