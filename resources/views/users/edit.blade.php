...
<div class="container-xl px-2 mt-n10">
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group (username) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="role">Username <span class="text-danger">*</span></label>
    ...
    <div x-data="{ open: false }">
        <div class="card mb-4">
            <div class="card-header" x-on:click="open = !open" style="cursor: pointer">
                Change Password
            </div>
            <div class="card-body" x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
