...
@section('content')
    ...
    <div class="container-xl px-2 mt-n10 productTableBody">
        <form action="{{ route('productions.update') }}" method="POST" id="productionForm"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select form-control-solid" id="name_production"
                                        name="name_production">
                                    <option value="">Pilih Produk</option>
                                    @foreach ($products as $prod)
                                        <option value="{{ $production->name }}"
                                                @if (!is_null($production->name) && $prod->id  === $production->name) selected @endif>
                                            {{ $prod->product_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    <label class="small mb-1" for="unit_id_production">Unit Item<span
                                            class="text-danger">*</span></label>
                                    <select class="form-select form-control-solid" id="unit_id_production"
                                            name="unit_id_production">
                                        <option value="">Pilih Unit</option>
                                        @foreach ($units as $unit)
                                            <option value="{{ $production->unit_id }}"
                                                    @if (!is_null($production->unit_id) && $unit->id === $production->unit_id) selected @endif>
                                                {{ $unit->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input
                                            ...
                                            placeholder=""
                                            value="{{ !is_null($production) ? $production->start_date : '' }}"
                                            autocomplete="off"/>
                                        @error('date_start_production')
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input
                                            ...
                                            placeholder=""
                                            value="{{ !is_null($production) ? $production->end_date : '' }}"
                                            autocomplete="off"/>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ !is_null($production) ? $production->detail : '' }}">
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ !is_null($production) ? $production->stock_production : '' }}">
                            ...
                            <select class="form-control select2" id="product_id" name="product_id"
                                ...
                                @foreach ($products as $product)
                                    <option value="{{ $product->id }}">{{ $product->product_name }}
                                        --{{$product->supplier->name}}--Rp.{{$product->buying_price}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
