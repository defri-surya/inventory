        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('agens.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus me-3"></i>Tambahkan</a>
                    <a href="{{ route('agens.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Bersihkan Pencarian</a>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="row mx-n4">
                <div class="col-lg-12 card-header mt-n4">
                    <form action="{{ route('agens.index') }}" method="GET">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">{{ (($agens->currentPage() * (request('row') ? request('row') : 10)) - (request('row') ? request('row') : 10)) + $loop->iteration  }}</th>
                                    <td>{{ $agen->name }}</td>
                                    <td>{{ $agen->email }}</td>
                                    <td>{{ $agen->phone }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('agens.edit', $agen->id) }}" class="btn btn-outline-primary btn-sm mx-1"><i class="fas fa-edit"></i></a>
