        ...
        <div class="page-header-content pt-4">
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('customers.index') }}">Marketing</a></li>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="account_holder">Akun Pemegang</label>
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="account_number">Nomor Akun</label>
                        ...
                        <a class="btn btn-danger" href="{{ route('customers.index') }}">Batalkan</a>
                    </div>
                </div>
