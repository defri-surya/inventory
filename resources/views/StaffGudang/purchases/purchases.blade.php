        ...
        <div class="container-xl px-4">
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4">
                        <a href="{{ route('purchasesGudang.getPurchaseReport') }}" class="btn btn-success add-list my-1"><i
                                class="fa-solid fa-file-export me-3"></i>Export</a>
                        <a href="{{ route('purchasesGudang.createPurchase') }}" class="btn btn-primary add-list my-1"><i
                                        ...
                                        <tr>
                                            ...
                                            @else
                                                <td class="text-center">
                                                    <span class="btn btn-warning btn-sm text-uppercase">Processed</span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('purchasesGudang.purchaseDetails', $purchase->id) }}"
                                                            class="btn btn-outline-success btn-sm mx-1"><i
                                                                class="fa-solid fa-eye"></i></a>
                                                        <a href="{{ route('purchasesGudang.PO', $purchase->id) }}"
