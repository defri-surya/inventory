            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4 d-flex align-items-end">
                        <form action="{{ route('purchasesGudang.dailyExportPurchaseReport') }}" method="POST"
                            class="d-inline mx-1">
                            @csrf
                            <button type="submit" class="btn btn-success add-list my-1"><i
                                    class="fa-solid fa-file-export me-3"></i>Export</button>
                        </form>
                        <a href="{{ route('purchasesGudang.allPurchases') }}" class="btn btn-danger add-list my-1"><i
                                    ...
                                    @foreach ($purchases as $purchase)
                                        <tr>
                                            ...
                                            @if ($purchase->purchase_status == 1)
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('purchasesGudang.purchaseDetails', $purchase->id) }}"
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="{{ route('purchasesGudang.purchaseDetails', $purchase->id) }}"
                                                            class="btn btn-outline-success btn-sm mx-1"><i
                                                                class="fa-solid fa-eye"></i></a>
                                                        <form
                                                            action="{{ route('purchasesGudang.deletePurchase', $purchase->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
