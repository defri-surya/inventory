                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @if ($purchase->purchase_status == 0)
                            <form action="{{ route('purchasesGudang.updatePurchase') }}" method="POST">
                                @csrf
                                @method('put')
                        ...
                        @elseif($purchase->paid !== 0)
                            <form action="{{ route('purchasesGudang.updatePurchasePaid') }}" method="POST">
                                @csrf
                                @method('put')
                                <input type="hidden" name="id" value="{{ $purchase->id }}">
                            ...
                            <a class="btn btn-danger"
                                href="{{ route('purchasesGudang.createReturn', $purchase->id) }}">Retur</a>
                        @else
                            <a class="btn btn-primary" href="{{ URL::previous() }}">Back</a>
                            <a class="btn btn-danger"
                                href="{{ route('purchasesGudang.createReturn', $purchase->id) }}">Retur</a>
