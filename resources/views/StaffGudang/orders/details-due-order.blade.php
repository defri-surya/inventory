                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control form-control-solid">{{ $order->toko->name }}</div>
                            </div>
                            <!-- Form Group (customer email) -->
                            <div class="col-md-6">
                                <label class="small mb-1">Email</label>
                                <div class="form-control form-control-solid">{{ $order->toko->email }}</div>
                            </div>
                        </div>
                        <!-- Form Row -->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control form-control-solid">{{ $order->toko->phone }}</div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control form-control-solid">{{ $order->toko->address }}</div>
                        </div>

                        <!-- Submit button -->
                        <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#modal">Pay
                            Due</button>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center mx-auto" id="modalCenterTitle">Invoice of
                        {{ $order->toko->name }}<br />Total Amount <b>${{ $order->total }}</b></h3>
                </div>

                <form action="{{ route('orderGudang.updateDueOrder') }}" method="POST">
                    @csrf
                    @method('put')
