        ...
        <div class="container-xl px-4">
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4">
                        <div class="col-auto my-4">
                            {{-- <a href="{{ route('salesGudang.getSalesReport') }}" class="btn btn-success add-list my-1"><i
                                    class="fa-solid fa-file-export me-3"></i>Export</a> --}}
                            <a href="{{ route('requestOrder.index') }}" class="btn btn-danger add-list my-1"><i
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            @if ($order->purchase_status == 1)
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('requestOrder.details', $order->id) }}"
                                                            class="btn btn-outline-success btn-sm mx-1"><i
                                                                class="fa-solid fa-eye"></i></a>
                                                    </div>
                                                </td>
                                            @elseif($order->purchase_status == 2)
                                                <td>
                                            ...
                                            @elseif($order->purchase_status == 3)
                                                <td>
                                            ...
                                            @elseif($order->purchase_status == 4)
                                                <td>
