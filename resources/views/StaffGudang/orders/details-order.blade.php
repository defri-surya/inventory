                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @if (!isset($deliveryOrder))
                            <a href="{{ route('delivery-orderGudang.create', $order->id) }}" class="btn btn-primary mb-1">
                                Buat Surat Jalan
                            </a>
                        @endif

                        @if ($order->order_status == 'pending')
                            <form action="{{ route('orderGudang.updateOrder') }}" method="POST">
                                @method('put')
                                @csrf
                        ...
                        @else
                            ...
                            @if (isset($deliveryOrder))
                                <a class="btn btn-primary"
                                    href="{{ route('orderGudang.deliveryOrder', $order->id) }}">Surat
                                    Jalan</a>
                            @endif
                        @endif
                    </div>
