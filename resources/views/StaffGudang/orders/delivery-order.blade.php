    ...
    <table class="c17">
        <tr class="c11">
            ...
            <td class="c28" colspan="1" rowspan="1">
                <p class="c13"><span class="c5">{{ $profil->name }}</span></p>
                <p class="c13"><span>{{ $profil->address }}</span></p>
                <p class="c13"><span>{{ $profil->phone }}</span></p>
            </td>
                ...
                <table class="c17">
                    <tr class="c8">
                        <td class="c2" colspan="1" rowspan="1">
                            <p class="c13"><span class="c5">Bill Payment To : </span></p>
                        </td>
                        <td class="c14" colspan="1" rowspan="1">
                            <p class="c10"><span class="c5">{{ $order->order->listtoko->name }}</span></p>
                            <p class="c1"><span class="c5">{{ $order->order->listtoko->address }}</span></p>
                            <p class="c1"><span class="c5">{{ $order->order->listtoko->phone }}</span></p>
                        </td>
                    </tr>
                    <tr class="c8">
                        <td class="c2" colspan="1" rowspan="1">
