...
@section('content')
            ...
            <div class="page-header-content pt-4">
                ...
                <nav class="mt-4 rounded" aria-label="breadcrumb">
                    <ol class="breadcrumb px-3 py-2 rounded mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('products-gudang.index') }}">Produks</a></li>
    ...
    <div class="container-xl px-2 mt-n10">
        <form action="{{ route('products-gudang.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-xl-4">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-danger" href="{{ route('products-gudang.index') }}">Cancel</a>
                        </div>
                    </div>
                    <!-- END: Produk Details -->
                </div>
