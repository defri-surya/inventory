            ...
            <div class="col-xl-12 mb-5">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            <form id="searchForm" action="{{ route('posGudang.index') }}" method="GET">
                                            ...
                                            <img class="img-fluid"  src="{{ $product->product_image ? asset('storage/products/'.$product->product_image) : asset('assets/img/products/default.webp') }}">
                                                ...
                                                @if ($product->discount_percent == 0)
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <form
                                                                action="{{ route('posGudang.addCartItem', $product->id) }}"
                                                                method="POST">
                                                                @csrf
            ...
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-striped align-middle">
                                ...
                                <tbody>
                                    @foreach ($carts as $item)
                                        @php
                                            $x = $products->find($item->id);
                                            // dd($x->stock);
                                        @endphp
                                        <tr>
                                            <td>{{ $item->name }}</td>
                                            <td style="min-width: 170px;">
                                                <form action="{{ route('posGudang.updateCartItem', $item->rowId) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="input-group">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <form action="{{ route('posGudang.deleteCartItem', $item->rowId) }}"
                                                        method="POST">
                                                        @method('delete')
                                                        @csrf
                        ...
                        <form action="{{ route('posGudang.createInvoice') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
