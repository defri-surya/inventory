...
@section('content')
            ...
            <div class="page-header-content pt-4">
                ...
                <nav class="mt-4 rounded" aria-label="breadcrumb">
                    <ol class="breadcrumb px-3 py-2 rounded mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('list-toko.index') }}">List Data Toko</a></li>
    ...
    <div class="container-xl px-2 mt-n10">
        <form action="{{ route('list-toko.update', $listtoko->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img class="img-account-profile rounded-circle mb-2"
                                src="{{ $listtoko->photo ? asset('storage/suppliers/' . $listtoko->photo) : asset('assets/img/demo/user-placeholder.svg') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-solid @error('email') is-invalid @enderror"
                                    ...
                                    value="{{ old('email', $listtoko->email) }}" />
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-solid @error('phone') is-invalid @enderror"
                                    ...
                                    value="{{ old('phone', $listtoko->phone) }}" />
                                @error('phone')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control form-control-solid @error('shopname') is-invalid @enderror"
                                        ...
                                        value="{{ old('shopname', $listtoko->shopname) }}" />
                                    @error('shopname')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror"
                                        ...
                                        <option value="BRI"
                                            @if (old('bank_name', $listtoko->bank_name) == 'BRI') selected="selected" @endif>
                                            BRI</option>
                                        <option value="BNI"
                                            @if (old('bank_name', $listtoko->bank_name) == 'BNI') selected="selected" @endif>
                                            BNI</option>
                                        <option value="BCA"
                                            @if (old('bank_name', $listtoko->bank_name) == 'BCA') selected="selected" @endif>
                                            BCA</option>
                                        <option value="BSI"
                                            @if (old('bank_name', $listtoko->bank_name) == 'BSI') selected="selected" @endif>
                                            BSI</option>
                                        <option value="Mandiri"
                                            @if (old('bank_name', $listtoko->bank_name) == 'Mandiri') selected="selected" @endif>Mandiri</option>
                                    </select>
                                    @error('bank_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('account_holder', $listtoko->account_holder) }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('account_number', $listtoko->account_number) }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-solid @error('address') is-invalid @enderror" id="address"
                                    name="address" rows="3">{{ old('address', $listtoko->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
