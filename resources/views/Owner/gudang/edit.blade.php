...
@section('content')
    ...
    <div class="container-xl px-2 mt-n10">
        <form action="{{ route('list-gudang.update', $gudang->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img class="img-account-profile rounded-circle mb-2"
                                src="{{ $gudang->photo ? asset('storage/suppliers/' . $gudang->photo) : asset('assets/img/demo/user-placeholder.svg') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-solid @error('address') is-invalid @enderror" id="address" name="address"
                                    rows="3">{{ old('address', $gudang->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
