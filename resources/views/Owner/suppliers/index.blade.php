                                ...
                                <tbody>
                                    @foreach ($suppliers as $supplier)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($supplier->status_id == 1)
                                                    <form id="status-form-{{ $supplier->id }}"
                                                        action="{{ route('change-status-supplier', $supplier->id) }}"
                                                        method="POST">
                                                        @method('PUT')
                                                        @csrf
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="status" type="checkbox"
                                                                role="switch"
                                                                id="flexSwitchCheckChecked-{{ $supplier->id }}" checked
                                                                onchange="submitForm({{ $supplier->id }})">
                                                        </div>
                                                    </form>
                                                @else
                                                    <form id="status-form-{{ $supplier->id }}"
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="status" type="checkbox"
                                                                role="switch"
                                                                id="flexSwitchCheckChecked-{{ $supplier->id }}"
                                                                onchange="submitForm({{ $supplier->id }})">
                                                        </div>
                                                    </form>
                                                @endif
