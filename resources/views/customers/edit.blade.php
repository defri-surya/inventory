            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="small font-italic text-muted mb-2 text-uppercase">Jpg atau Png maksimal 2mb</div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="nik">NIK<span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid @error('nik') is-invalid @enderror" id="nik" name="nik" type="text" placeholder="" value="{{ old('nik', $customer->nik) }}" />
                                @error('nik')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <!-- Form Group (npwp number) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="npwp">NPWP<span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid @error('npwp') is-invalid @enderror" id="npwp" name="npwp" type="text" placeholder="" value="{{ old('npwp', $customer->npwp) }}" />
                                @error('npwp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (phone number) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="phone">Nomor Telp. <span class="text-danger">*</span></label>
