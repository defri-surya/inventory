                        ...
                        <div class="card-body">
                            ...
                            @role('Admin_Toko')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-solid @error('npwp') is-invalid @enderror"
                                        ...
                                        value="{{ old('npwp', $toko->npwp) }}" autocomplete="off" />
                                    @error('npwp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-solid @error('phone') is-invalid @enderror"
                                        ...
                                        value="{{ old('phone', $toko->phone) }}" autocomplete="off" />
                                    @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-solid @error('address') is-invalid @enderror" id="address"
                                        name="address" type="text" placeholder="" autocomplete="off" rows="5">{{ old('address', $toko->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            @role('Admin_Gud')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-solid @error('npwp') is-invalid @enderror"
                                        id="npwp" name="npwp" type="number" placeholder=""
                                        value="{{ old('npwp', $gudang->npwp) }}" autocomplete="off" />
                                    @error('npwp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-solid @error('phone') is-invalid @enderror"
                                        id="phone" name="phone" type="number" placeholder=""
                                        value="{{ old('phone', $gudang->phone) }}" autocomplete="off" />
                                    @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    <label class="small mb-1" for="address">Address</label>
                                    <textarea class="form-control form-control-solid @error('address') is-invalid @enderror" id="address"
                                        name="address" type="text" placeholder="" autocomplete="off" rows="5">{{ old('address', $gudang->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
