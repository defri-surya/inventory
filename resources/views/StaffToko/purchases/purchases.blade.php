        ...
        <div class="container-xl px-4">
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4">
                        <a href="{{ route('purchasesToko.getPurchaseReport') }}" class="btn btn-success add-list my-1"><i
                                class="fa-solid fa-file-export me-3"></i>Export</a>
                        <a href="{{ route('purchasesToko.createPurchase') }}" class="btn btn-primary add-list my-1"><i
                                class="fa-solid fa-plus me-3"></i>Add</a>
                        <a href="{{ route('purchasesToko.allPurchases') }}" class="btn btn-danger add-list my-1"><i
                ...
                <nav class="mt-4 rounded" aria-label="breadcrumb">
                    <ol class="breadcrumb px-3 py-2 rounded mb-0">
                        ...
                        <li class="breadcrumb-item active">Purchase List Toko</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($purchases as $purchase)
                                        <tr>
                                            ...
                                            <td>{{ $purchase->gudang->name }}</td>
                                            <td>{{ $purchase->purchase_date }}</td>
                                            <td>{{ $purchase->total_amount }}</td>
                                            @if ($purchase->purchase_status == 1)
                                                <td>
                                                    <span class="btn btn-success btn-sm text-uppercase">Sudah Datang Belum
                                                        Lunas</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('purchasesToko.purchaseDetails', $purchase->id) }}"
                                            ...
                                            @elseif($purchase->purchase_status == 2)
                                                <td>
                                                    <span class="btn btn-success-soft btn-sm text-uppercase">Sudah Datang
                                                        Sudah Lunas</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                            ...
                                            @elseif($purchase->purchase_status == 3)
                                                <td>
                                                    <span class="btn btn-success btn-sm text-uppercase">Warehouse
                                                        Processing</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                            ...
                                            @elseif($purchase->purchase_status == 4)
                                                <td>
                                                    <span class="btn btn-success btn-sm text-uppercase">Delivery
                                                        Process</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                            ...
                                            @else
                                                <td>
                                                    <span class="btn btn-warning btn-sm text-uppercase">Order
                                                        Request</span>
                                                </td>

                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('purchasesToko.PO', $purchase->id) }}"
                                                        ...
                                                        <a href="{{ route('purchasesToko.purchaseDetails', $purchase->id) }}"
                                                            class="btn btn-outline-success btn-sm mx-1"><i
                                                                class="fa-solid fa-eye"></i></a>
                                                        <form
                                                            action="{{ route('purchasesToko.deletePurchase', $purchase->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
