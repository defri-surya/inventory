        ...
        <div class="container-xl px-4">
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4 d-flex align-items-end">
                        <form action="{{ route('purchasesToko.dueExportPurchaseReport') }}" method="POST"
                            class="d-inline mx-1">
                            @csrf
                            <button type="submit" class="btn btn-success add-list my-1"><i
                                    class="fa-solid fa-file-export me-3"></i>Export</button>
                        </form>
                ...
                <nav class="mt-4 rounded" aria-label="breadcrumb">
                    <ol class="breadcrumb px-3 py-2 rounded mb-0">
                        ...
                        <li class="breadcrumb-item active">Purchase List Due</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($purchases as $purchase)
                                        <tr>
                                            ...
                                            @else
                                                <td>
                                                    <span class="btn btn-warning btn-sm text-uppercase">Sudah Datang Sudah
                                                        Lunas</span>
                                                </td>
