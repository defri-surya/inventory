                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control form-control-solid">{{ $purchase->gudang->name }}</div>
                            </div>
                            <!-- Form Group (supplier email) -->
                            <div class="col-md-6">
                                <label class="small mb-1">Email</label>
                                <div class="form-control form-control-solid">{{ $purchase->gudang->email }}</div>
                            </div>
                        </div>
                        <!-- Form Row -->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control form-control-solid">{{ $purchase->gudang->phone }}</div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control form-control-solid">{{ $purchase->gudang->address }}</div>
                        </div>
                        ...
                        @if ($purchase->arrival_date != null)
                            <a class="btn btn-success mt-1"
                                href="{{ route('purchasesToko.invoiceBill', $purchase->id) }}">Tagihan</a>
                        @endif
                    </div>
                </div>
            </div>
