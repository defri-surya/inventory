            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4">
                        ...
                        <a href="{{ route('stockGudang.index') }}" class="btn btn-danger add-list my-1"><i
            ...
            <div class="card-body">
                <div class="row mx-n4">
                    <div class="col-lg-12 card-header mt-n4">
                        <form action="{{ route('stockGudang.index') }}" method="GET">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-striped align-middle">
                                ...
                                <tbody>
                                    @foreach ($stockgudangs as $product)
                                        <tr>
                                            <th scope="row">
                                                {{ $stockgudangs->currentPage() * (request('row') ? request('row') : 10) - (request('row') ? request('row') : 10) + $loop->iteration }}
                                            </th>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <!-- Show Detail -->
                                                    <a href="{{ route('stockGudang.show', $product->product_name) }}"
