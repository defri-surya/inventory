            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4">
                        ...
                        <a href="{{ route('order.completeOrders') }}" class="btn btn-danger add-list my-1"><i
                                ...
                                <tbody>
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('orderToko.orderCompleteDetails', $order->id) }}"
                                                        class="btn btn-outline-success btn-sm mx-1"><i
                                                            class="fa-solid fa-eye"></i></a>
                                                    <a href="{{ route('orderToko.downloadInvoice', $order->id) }}"
